...
**Step 8:** Make a folder on your computer called `"repos"`. I recommend putting it inside your username in the `Users` folder, on the same level as `"Documents"`. 
...
(If you are using Windows, try typing `cd` instead).
...
Type `ls`. This stands for "list" as in "list all the files in this directory." `ls` is commonly used to quickly see contents of a folder. (If you are on Windows, type "dir" instead -- for directory.)
...
... and press `Enter`.   (You don't need to use the "<" or ">" symbols.)    

&nbsp; 

**Step 19:** Now look in your "repos" folder. You should see a folder with the same name as your repo. If so, BOOM.  
...
**Step 20:** Back in `RStudio`, make a new `RMarkdown` file. To do so, click on the green plus sign at the top-left of your window, and in the drop-down menu click on the "R Markdown ..." option.  
...
**Step 21:** Give your new `R Markdown` file a name -- whatever you want. Provide your own name as the author.   
...
**Step 22:** Once you click "OK", you should see something like this, which has some demo text and code included for you to see how `Rmd` works.  

![](../img/rmd_open.png)

&nbsp;  

**Step 23:** Click on the "Knit" button on the top pane. If a drop-down button appears, choose "Knit to HTML".     

![](../img/rmd_knit.png)
&nbsp; 

It will ask you to save the file first. Save it *inside* your `test_repo` folder. Call it `index.Rmd`.  
